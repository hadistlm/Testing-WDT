        ...
        <div class="flex flex-wrap -m-4">
          <div v-for="article in postList" :key="article.id" class="xl:w-1/3 md:w-1/2 p-4">
            <div class="bg-white p-6 rounded-lg">
              ...
              <NuxtLink :to="{ path: `/article/${article.slug}`}" class="inline-flex mt-3 items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                Read more
